...
//       permission.actions.some(action => !['Manage', 'Create', 'Edit', 'Delete', 'Show', 'Move', 'Add'].includes(action))
//     );

//     if (invalidPermission) {
//       return res.status(400).json({ message: 'Invalid permissions format or action provided.' });
//     }
